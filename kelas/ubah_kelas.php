              ...
              <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="hidden" class="form-control form-control-sm" id="id" name="id" placeholder="id" value="<?=$kelas[0]['id_kelas']?>">
                      <input type="text" class="form-control form-control-sm" id="nama" name="nama" placeholder="Nama Kelas" value="<?=$kelas[0]['nama_kelas']?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <select class="select2-single form-control form-control-sm" name="jenjang" required id="select2Single">
                        ...
                        <option <?=($kelas[0]['jenjang']=="X")?'selected':''?> value="X">X</option>
                        <option <?=($kelas[0]['jenjang']=="XI")?'selected':''?> value="XI">XI</option>
                        <option <?=($kelas[0]['jenjang']=="XII")?'selected':''?> value="XII">XII</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <select class="select2-single form-control form-control-sm" name="wali_kelas" required id="select2Single">
                        ...
                        <?php foreach ($wali_kelas as $wk) { ?>
                          <option <?=($kelas[0]['wali_kelas']==$wk['id'])?'selected':''?> value="<?=$wk['id']?>"><?=$wk['nama_guru']?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-9">
                      <select class="select2-single form-control form-control-sm" name="jurusan" required id="select2Single">
                        ...
                        <?php foreach ($jurusan as $j) { ?>
                          <option <?=($kelas[0]['id_jurusan']==$j['id'])?'selected':''?> value="<?=$j['id']?>"><?=$j['nama_jurusan']?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-9">
                      <select class="select2-single form-control form-control-sm" name="tahun_akademik" required id="select2Single">
                        ...
                        <?php foreach ($tahun_akademik as $ta) { ?>
                          <option <?=($kelas[0]['id_tahun_akademik']==$ta['id'])?'selected':''?> value="<?=$ta['id']?>"><?=$ta['tahun_mulai'].'/'.$ta['tahun_selesai']?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
